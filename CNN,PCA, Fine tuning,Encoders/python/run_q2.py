...
# Q 2.1
# initialize a layer
nn.initialize_weights(2,25,params,'layer1')
nn.initialize_weights(25,4,params,'output')
...
# Q 2.2.1
# implement sigmoid
test = nn.sigmoid(np.array([-1000,1000]))
print('should be zero and one\t',test.min(),test.max())
# implement forward
h1 = nn.forward(x,params,'layer1')
print(h1.shape)
# Q 2.2.2
# implement softmax
...
delta2 = nn.backwards(delta1,params,'output',nn.linear_deriv)
# Implement backwards!
nn.backwards(delta2,params,'layer1',nn.sigmoid_deriv)
...
# Q 2.4
batches = nn.get_random_batches(x,y,5)
# print batch sizes
...
for itr in range(max_iters):
    ...
    for xb,yb in batches:
        ...
        FLayer1 =  forward(xb,params, 'layer1',sigmoid)
...
FLayer1 =  forward(x,params, 'layer1',sigmoid)
...
#     print("v shape: ", v.shape)
    ...
    if v.ndim !=1:
        vshape0,vshape1 = v.shape
    else:
        vshape0 = len(v)
        vshape1 = 1
        
        
    for i in range(vshape0):
            for j in range(vshape1):
